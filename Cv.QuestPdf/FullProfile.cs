...
public class FullProfile {
    public void Get(ColumnDescriptor columnDescriptor) {
        ...
        columnDescriptor.Item().PaddingTop(10).Text(".NET Developer @ Itineris (BE) : 11/22 - 08/25").FontSize(18)
            .Bold()
            .AlignCenter();
        columnDescriptor.Item().PaddingTop(10).Row(AddItineris);

        columnDescriptor.Item().PaddingTop(10).Text(".NET Developer @ EUAA (MT) : 03/25 - 07/25").FontSize(18).Bold()
            .AlignCenter();
        columnDescriptor.Item().PaddingTop(10).Row(AddEuaa);

        columnDescriptor.Item().PaddingTop(10).Text(".NET Developer @ EPS (LT) : 02/25 - 06/25").FontSize(18).Bold()
            .AlignCenter();
        columnDescriptor.Item().PaddingTop(10).Row(AddEps);

        columnDescriptor.Item().PaddingTop(10).Text(".NET Developer @ Lykke (CH) : 07/24 - 12/24").FontSize(18).Bold()
            .AlignCenter();
        columnDescriptor.Item().PaddingTop(10).Row(AddLykke);

        columnDescriptor.Item().PaddingTop(10).Text(".NET Developer @ ING Bank (RO) : 04/23 - 09/24").FontSize(18)
            .Bold()
            .AlignCenter();
        columnDescriptor.Item().PaddingTop(10).Row(AddIng);

        columnDescriptor.Item().PaddingTop(10).Text(".NET Developer @ American Express (US) : 03/23 - 07/24")
            .FontSize(18).Bold()
            .AlignCenter();
        columnDescriptor.Item().PaddingTop(10).Row(AddAmex);

        columnDescriptor.Item().PaddingTop(10).Text(".NET Developer @ Klips (IL) : 08/22 - 03/23").FontSize(18).Bold()
            .AlignCenter();
        columnDescriptor.Item().PaddingTop(10).Row(AddKlips);

        columnDescriptor.Item().PaddingTop(10).Text(".NET Developer @ Axa IM (FR) : 07/22 - 02/23").FontSize(18).Bold()
            .AlignCenter();
        columnDescriptor.Item().PaddingTop(10).Row(AddAxa);
        
        columnDescriptor.Item().PaddingTop(10).Text(".NET Developer @ GlobalLogic (US) : 03/23 - 06/23").FontSize(18)
            .Bold()
            .AlignCenter();
        columnDescriptor.Item().PaddingTop(10).Row(AddGlobalLogic);

        columnDescriptor.Item().PaddingTop(10).Text(".NET Developer @ BeeNear (RO) : 05/21 - 05/22").FontSize(18).Bold()
            .AlignCenter();
        columnDescriptor.Item().PaddingTop(10).Row(AddBeeNear);

        columnDescriptor.Item().PaddingTop(10).Text(".NET Developer @ Enedis (FR) : 02/19 - 02/21").FontSize(18).Bold()
            .AlignCenter();
        columnDescriptor.Item().PaddingTop(10).Row(AddEnedis);

        columnDescriptor.Item().PaddingTop(10).Text(".NET Developer @ Societe Generale (FR) : 06/18 - 01/19")
            .FontSize(18).Bold()
            .AlignCenter();
        columnDescriptor.Item().PaddingTop(10).Row(AddSocGen);

        columnDescriptor.Item().PaddingTop(10).Text(".NET Developer @ Tricentis (AT) : 12/17 - 05/18").FontSize(18)
            .Bold()
            .AlignCenter();
    ...
    void AddEuaa(RowDescriptor row) {
        ...
        row.RelativeItem().Column(col => {
            ...
            col.Item().PaddingTop(5).Text(text => {
                ...
                text.Span(
                    "Developed an interactive dashboard for deployment plans that provides instant visibility " +
            ...
            col.Item().PaddingTop(5).Text(text => {
                ...
                text.Span(
                    "Dramatically improved task fetching performance by optimizing SQL entity relationships " +
    ...
    void AddGlobalLogic(RowDescriptor row) {
        ...
        row.RelativeItem().Column(col => {
            ...
            col.Item().PaddingTop(5).Text(text => {
                ...
                text.Span("Business: ").Italic();
                text.Span(
                    "GlobalLogic, a Hitachi Group Company, is a leader in digital product engineering. They help " +
            ...
            col.Item().PaddingTop(5).Text(text => {
                ...
                text.Span("Technical: ").Italic();
                text.Span(
                    "Ensured 24/7 operational support for a US-based automated car wash business. Developed a " +
        ...
        row.RelativeItem().Column(col => {
            ...
            col.Item().PaddingTop(5).Text(text => {
                ...
                text.Span(
                    "Coordinated a team to create a comprehensive virtualized environment simulating the entire " +
                    "car wash operation.");
            });

            col.Item().PaddingTop(5).Text(text => {
                text.Justify();
                text.Span("Implemented clean code and test-driven development (TDD) practices: ").SemiBold()
                    .Italic();
                text.Span(
                    "Ensured high-quality codebase, emphasizing maintainability, readability, and testability. " +
            ...
            col.Item().PaddingTop(5).Text(text => {
                ...
                text.Span(
                    "Maintained open communication with stakeholders, demonstrating project progress, achieved " +
